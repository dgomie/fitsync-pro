          ...
          <Paper elevation={3} sx={{ padding: { xs: 2, sm: 4, md: 6 } }}>
            ...
            <Box component="main">
              ...
              <Box mb={4} id="mission-values">
                ...
                <Typography variant="body1">
                  Our mission is to promote a healthy and active lifestyle by
                  providing innovative fitness solutions that inspire and
              ...
              <Box mb={4} id="team">
                ...
                <Grid container spacing={4} justifyContent="center">
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    <a
                      href="https://github.com/kaylommy"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Card sx={{ maxWidth: 345, mx: "auto" }}>
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    <a
                      href="https://github.com/ortzfrancisco"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Card sx={{ maxWidth: 345, mx: "auto" }}>
              ...
              <Box mb={4} id="achievements">
                ...
                <Typography variant="body1">
                  We are proud to have helped thousands of individuals reach
                  their fitness milestones and transform their lives through our
                  innovative fitness programs and state-of-the-art technology.
                </Typography>
              </Box>
              <Box mb={4} id="contact">
                <Typography variant="h4" component="h2" gutterBottom>
                ...
                <Typography variant="body1">
                  ...
                  <Link
                    href="mailto:devs.fitsyncpro@gmail.com"
                    underline="hover"
                  >
